...
void setup() {
  ...
  moveNorthAlignedBy(distanceToFirstIntersection, 8);
  haltTimed(1000);
  debugDistanceSensors();
  //moveWestAlignedByTo(distanceToFirstIntersection, 50); //getDistanceB1() + getDistanceX1() + turretCenterX
    debugDistanceSensors();
  debugDistanceSensors();
  debugDistanceSensors();
  debugDistanceSensors();
  ...
  debugDistanceSensors();
  moveWestAlignedByTo(distanceToFirstIntersection, getDistanceB1() + getDistanceX1() + turretCenterX); //getDistanceB1() + getDistanceX1() + turretCenterX
...
void moveEastTimed(long durationMilliseconds) {
  ...
  motorBank_EW_2.writeMicroseconds(1450); //Rotate motors in North and South direction at full speed   
...
void moveWestTimed(long durationMilliseconds) {
  ...
  motorBank_EW_2.writeMicroseconds(1550); //Rotate motors in North and South direction at full speed   
...
void moveWestAlignedByTo(int yCoordinateAlignedBy, int xCoordinateSentTo) {

  long distanceY1 = getDistanceY1();
  Serial.println(xCoordinateSentTo);
  while(((getDistanceX1() + getDistanceX2())/2.0) < xCoordinateSentTo)
  {
    moveWestAligned();
    distanceY1 = getDistanceY1();
    if (distanceY1 < yCoordinateAlignedBy) {
